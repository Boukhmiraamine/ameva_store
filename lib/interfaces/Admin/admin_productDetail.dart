...
class AProductDetail extends StatefulWidget {
  ...
  const AProductDetail({Key? key, required this.product}) : super(key: key);
  @override
  State<AProductDetail> createState() => _AProductDetailState();
}
class _AProductDetailState extends State<AProductDetail> {
  @override
