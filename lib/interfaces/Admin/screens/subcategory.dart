...
class SubCategoryState extends State<SubCategory>{
  ...
  List<CategoryModel> subcategoryModel = <CategoryModel>[
    CategoryModel(name: "Roman",description: "",parent_id: 1),
    CategoryModel(name: "Ligth Novel",description: "",parent_id: 1)
  ];
