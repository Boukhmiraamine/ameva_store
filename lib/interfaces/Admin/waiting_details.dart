...
class AWProductDetail extends StatefulWidget {
  ...
  const AWProductDetail({Key? key, required this.product}) : super(key: key);
  @override
  State<AWProductDetail> createState() => _AWProductDetailState();
}
class _AWProductDetailState extends State<AWProductDetail> {
  @override
